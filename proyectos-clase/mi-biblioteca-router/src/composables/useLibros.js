...
export function useLibros() {
    ...
    function getLibroPorId(id) {
        return libros.value.find(l => l.id === parseInt(id))
    }

    return { filtro, librosFiltrados, reservasUsuario, MAX_RESERVAS, reservarLibro, getLibroPorId , libros}
}
